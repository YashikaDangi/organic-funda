        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white border border-[#CFC5BA] rounded-xl shadow-lg p-6 mb-8">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <h2 className="text-xl font-bold text-[#0E1C4C]">
                    Order #{order.orderNumber}
                  </h2>
                  <p className="text-[#4B423A] mt-1">
              ...
              <div className="border-t border-[#E6E1DC] pt-6">
                <h3 className="text-lg font-semibold text-[#0E1C4C] mb-4">
                  Items
                </h3>
                <div className="space-y-4">
                  {order.items.map((item) => (
                    <div
                      key={item.id}
                      className="flex justify-between items-center pb-4 border-b border-[#E6E1DC] last:border-0 last:pb-0"
                    >
                      <div className="flex items-center">
                        ...
                        <div>
                          <h4 className="font-medium text-[#0E1C4C]">
                            {item.name}
                          </h4>
                          <p className="text-sm text-[#4B423A]">
                            Quantity: {item.quantity}
                          </p>
                        </div>
                      </div>
                      <div className="text-right">
                        <p className="font-medium text-[#0E1C4C]">
                          u20b9{item.price.toFixed(2)}
                        </p>
                        <p className="text-sm text-[#4B423A]">
                          Total: u20b9{(item.price * item.quantity).toFixed(2)}
                        </p>
                      </div>
                    </div>
                  ))}
          ...
          <div className="lg:col-span-1">
            <div className="bg-white border border-[#CFC5BA] rounded-xl shadow-lg p-6 space-y-4">
              <h3 className="text-lg font-semibold text-[#0E1C4C] border-b border-[#E6E1DC] pb-2">
                Payment Summary
              </h3>
                ...
                <div className="flex justify-between text-[#4B423A]">
                  ...
                  <span>
                    {order.shippingCost === 0
                      ? "Free"
                      : `u20b9${order.shippingCost.toFixed(2)}`}
                  </span>
                </div>
              ...
              <div className="border-t border-[#E6E1DC] pt-4 mt-4">
                <h4 className="font-medium text-[#0E1C4C] mb-2">
                  Payment Information
                </h4>
